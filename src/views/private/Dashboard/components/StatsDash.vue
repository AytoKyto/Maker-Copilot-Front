<template>
    <div class="flex space-x-2 mt-5">
        ...
        <div class="w-1/2 h-52 flex flex-col space-y-2 px-2">
            <div class="h-full flex items-center justify-between space-x-2 mb-3">
                <p class="text-20 font-semibold">Balence de ventes</p>
